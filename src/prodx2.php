...
<div class="section var">

 <div class="container">

<div class="row"> 	

 <div class="line">Metal roof<span></span></div>

  <div class="col s12 m8 offset-m2">

  	 <span class="title_center">Choose your roof</span> <span class="right"><a href="http://localhost/solarkitindia.com/new/prodx2.php" class="reset black-text">Reset filter<i class="material-icons">close</i></a></span>
...
.varianty .col:nth-child(10) span,.varianty .col:nth-child(11) span{
 ...
 <div class="col s6 m4 offset-m2 va_5">

  <label for="r9">

  	<input id="r9" class="browser-default" type="radio" name="va_5" value="30""/>

  <span class="r9">Rail H30mm</span>
...
<div class="col s6 m4 va_5">
 ...
 <div class="col s6 m4 offset-m2">
  ...
  <span class="r7">End & Mid Clamp</span>
...
<div class="col s6 m4  ">
 ...
 <span class="r8">ARaymond Clip</span>
 	...
 	<div class="col s3 m2 offset-m2 va_3">
...
for (var i = 0; i < inputs.length; ++i) {  groups.push(inputs[i].name) }
...
if($("input:radio[name='" + groups[i] +"']:checked").length > 0) {

	console.log("c " + $("input:radio:checked").length);

if ($("input:radio:checked").length <6) $("input[name='" + groups[i] +"']").closest("label").find("span").hide();

} else {

	

	console.log(groups[i] + " " + i);

	groups_1.push(groups[i]);

	//if (groups[i]=="va_3") alert(groups[i]);
