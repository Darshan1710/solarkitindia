...
<html>
   ...
   <head>
      ...
      <title>Career | Solarkitindia</title>

      <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">

      <link rel="stylesheet" type="text/css" href="<?= $link;?>assets/css/grid.css">

      <link rel="stylesheet" type="text/css" href="<?= $link;?>assets/css/style.css">
   ...
   <section>
      <div class="slideshow-container">
         <div class="mySlides fade">
            ...
            <img src="<?= $link; ?>assets/images/banner.png" style="width:100%">
            <div class="text"></div>
         </div>
   ...
   <div class="container">
      <div class="row">
         <div class="col-md-3 col-sm-12">
            <div class="image-div">
               <img src="<?= $link; ?>assets/images/men1.png">
            </div>
         </div>
   ...
   <div class="container-fluid">
      <div class="row" style="overflow: hidden;">
         <div class="col-md-8 col-sm-12 content2">
            <div class="content">
         ...
         <div class="col-md-4 col-sm-12">
            <div class="image2-div">
               <img src="<?= $link; ?>assets/images/solor.png">
            </div>
         </div>
      </div>
   </div>
   ...
   <div class="container">
      <div class="row">
         <div class="img3-div col-sm-12">
            <img src="<?= $link; ?>assets/images/men2.png">
         </div>
   ...
   <div class="container-fluid">
      <div class="row">
         ...
         <div class="col-md-4 col-sm-12">
            <div class="how-img">
               <img src="<?= $link; ?>assets/images/we.png">
            </div>
         </div>
      </div>
   </div>
   ...
   <div class="container">
      <div class="container">
         <div class="row">
            <div class="col-md-12 col-sm-12">
               <div class="pos-img">
                  <img src="<?= $link; ?>assets/images/open.png">
                  ...
                  <div class="outer">
                     ...
                     <details>
                        ...
                        <div class="faq-content">
                           ...
                           <br><br>
                           <h5>Sales Manager Responsibilities:</h5>
                           <br>
                           <ul class="ul">
                     ...
                     <details>
                        ...
                        <div class="faq-content">
                           ...
                           <br>
                           <p><b>Language</b> : Tamil,Hindi and English is Mandtory</p>
                           <br>
                           <p><b>Location</b> : Panvel Maharashtra</p>
                           <br>
                           <p><b>Number Of Openings</b> : 2</p>
                           <br><br>
                           <p><b>For North and West India</b></p>
                           <br>
                           <p><b>Language</b> : Hindi and English is Mandtory</p>
                           <br>
                           <p><b>Location</b> : Panvel Maharashtra</p>
                           <br>
                           <p><b>Number Of Openings</b> : 1</p>
                           <br>
                           <br>
                           ...
                           <br>
                           <h5><u>Roles & Responsibilities:</u></h5>
                           <ul class="ul">
   ...
   <div class="container">
      ...
      <h5 class="heading-form mobile">If open position does not match with your profile then please apply here!</h5>
      <form method="post" id="career" enctype="multipart/form-data">
         <div class="row">
            ...
            <div class="col-md-6 col-sm-12 last_name">
               <div class="form-group font-weight-bold">
                  <label >&nbsp;</label>
            ...
            <div class="col-md-6 col-sm-12">
               <div class="form-group font-weight-bold " style="display: grid;">
                  ...
                  <select name="field" id="field" class="select-fields" style="height: 35px;
                     margin-top: 10px;border: none;">
                     <option value="">Please Select Field of Interest</option>
            ...
            <div class="col-md-6 col-sm-12">
               <div class="form-group font-weight-bold" style="display: grid;">
                  ...
                  <input id="file-upload" class="cv" style="display: none;" type="file" name="cv" />
               ...
               <div class="form-group font-weight-bold check">
                  ...
                  <div class="row">
                     <div class="col-sm-2" style="width:16%">
                        <input type="checkbox" name="communityCheckbox" class="form-control checkbox2" value="1">
                     </div>
                     <div class="col-sm-10 feedback-text">Yes, I'm willing to provide feedback </div>
...
<form id="cta-form" action='https://crm.zoho.com/crm/WebToLeadForm' name=WebToLeads3599922000023079001 method='POST' onSubmit='javascript:document.charset="UTF-8"; return checkMandatory3599922000023079001()' accept-charset='UTF-8'>
 <h4>Contact us</h4>
 <input type='text' style='display:none;' name='xnQsjsdp' value='cc77978e3d8adfa296093a6728be5389a9ff81e23b5440690873665282bb2c21'>
 <input type='hidden' name='zc_gad' id='zc_gad' value=''>
 <input type='text' style='display:none;' name='xmIwtLD' value='87e02a7af85ee721b7ca2876d1d9b8d6bf1bcea6f443b703bb9977f0e27fec6c'>
 <input type='text'  style='display:none;' name='actionType' value='TGVhZHM='>
 <input type='text' style='display:none;' name='returnURL' value='http://localhost/solarkitindia.com/form-submitted' >
...
<div class='zcwf_row'>
   <div class='zcwf_col_fld'><i class='material-icons'>email</i>
      <input type='text' ftype='email' id='Email' name='Email' maxlength='100' placeholder="Email">
      <div class='zcwf_col_help'>
      </div>
   </div>
</div>
...
<div class='zcwf_row'>
   <div class='zcwf_col_fld'><i class='material-icons'>message</i>
...
<div class='zcwf_row'> 
   ...
   <div class='zcwf_col_fld'>
      <div class='g-recaptcha' data-sitekey='6LdkBeEZAAAAAEbjyxeOlTjd6ib-vAWwNj4q-oCD' data-theme='light' data-callback='rccallback3599922000023079001' captcha-verified='false' id='recap3599922000023079001'>
      </div>

   <div  id='recapErr3599922000023079001' style='font-size:12px;color:red;visibility:hidden;'>Captcha validation failed. If you are not a robot then please try again.</div>
   </div>
</div>
...
<div class='zcwf_row'>
   ...
   <div class='dIB vat' align='left'>
      <div class='displayPurpose  f13'>
         <label class='newCustomchkbox-md dIB w100per'><input autocomplete='off' id='privacyTool3599922000023079001' type='checkbox' name='privacyTool' onclick='disableErr3599922000023079001()'>
   ...
   <div  id='privacyErr3599922000023079001' style='font-size:12px;color:red;padding-left: 5px;visibility:hidden;'>Please accept this</div>
   </div>
</div>
                    ...
                    if (obj.errorFlag == false) {
                     ...
                     window.location.reload();
                        ...
                        $.each(obj.messages, function(key, value) {
                            ...
                            if(key == 'field'){
                              element.closest('.select-fields').after(value);
                            }else if(key == 'cv'){
                              $('.cv').after(value);
                            }else if(key == 'communityCheckbox'){
                              $('.checkbox-error').html(value);
                            }else{
