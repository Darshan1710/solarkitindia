...
$categories = mysqli_query($con,$categories_query);
?>
...
<head>
    ...
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>Metal Roof Solar Mounting,Tile Roof Solar Mounting Brackets,solar panel mounting accessories</title>
    <meta name="keywords" content="solar cable clip,,Rv Solar Panel Mounts,solar panel clamps" />
    <meta name="description" content="We are best solar panel mounting kits and accessorries supplier from China. Discover the easy-to-attach solar mounting solutions from Solar Kitpvmount.com." />
    <meta name="google-site-verification" content="0hlmt6XTPq9hWJUMwJe9WG8xzEZXv56X8cNMCA1UqUo" />
    <link rel="canonical" href="https:///" />
    <meta property="og:image" content=""/>
    <link rel="alternate" href="products.php" hreflang="x-default" />
    <link type="text/css" rel="stylesheet" href="demo/template/css/bootstrap.css" />
    <link type="text/css" rel="stylesheet" href="demo/template/css/font-awesome.min.css">
    <link type="text/css" rel="stylesheet" href="demo/template/css/style.css" />
    ...
    <script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
        ...
        })(window,document,'script','dataLayer','GTM-MHLN7QZ');
    </script>
    <!-- End Google Tag Manager -->
</head>
<body>
<!-- Google Tag Manager (noscript) -->
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-MHLN7QZ"
                    ...
                    <div class="top_cent clearfix">
                            ...
                            <li>
                                <div class="menu">
                                    ...
                                    <ul class="menu-dropdown">
                                        ...
                                        <li>
                                            <a href="#">
                                                <img src="template/images/nl.png" />
                                                <p>Nederlands</p>
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="#">
                                                <img src="template/images/ja.png" />
                                                <p>日本語</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#">
                                                <img src="template/images/ms.png" />
                                                <p>Melayu</p>
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="#">
                                                <img src="template/images/cn.png" >
                                                <p>中文</p>
                                            </a>
                                        </li>
                                    </ul>
                        ...
                        <ul class="head_con clearfix">
                            <li>
                                ...
                                <div class="wrap">
                                    <p>Tel : </p>
                                    <a rel="nofollow" href="Tel:+91-86-5757-1188">+91-86-5757-1188</a>
                                </div>
                            </li>
                            <li>
                                ...
                                <div class="wrap">
                                    <p>Email : </p>
                                    <a rel="nofollow" href="mailto:sales@solar-kit.in">sales@solar-kit.in</a>
                                </div>
                            </li>
                        </ul>
                    </div>
                    ...
                    <section class="block blockcms column_box">
                        ...
                        <div class="block_content toggle_content">
                            <ul class="list clearfix">
                                ...
                                $newProducts = mysqli_query($con,$newProductsQuery);
                                if($newProducts){
                                ...
                                <li class="clearfix">
                                    <div class="box clearfix">
                                        <div class="image pro_image">
                                            <a href="#"></a>
                                            <img id="product_detail_img"  alt="<?php echo $newProductsRow['title'] ?>" src="uploadfile/202105/04/c023edc335f5d6a29929708b1331f100_small.jpg" />                                                <em class="icon"><i></i></em>
                                        </div>
                                        <div class="main">
                            ...
                            <li class="wow">
                                <div class="clearfix">
                                    <div class="cbp-vm-image">
                                        <a class="link" href="#"></a>
                                        <img id="product_detail_img"  alt="Solar Panel L Feet" src="uploadfile/202104/25/a3df24a73458d41ce0e6ce1af5b46601_small.jpg" />
                                        <div class="cbp-image-hover"><img src="uploadfile/202104/25/1aa029a74e8b902399c15a5c2d174ab4_small.jpg" alt="Solar L Feet for Tin Roof Mount"></div>
                                        <div class="line"></div>
                                        <div class="ovrly"></div>
                                        <div class="icon_box">
                                            <div class="icon"></div>
                                    ...
                                    <div class="cbp-list-center clearfix">
                                        <div class="cbp-list-left">
                                            <a class="cbp-title" href="#"><?php echo $productRow['title'] ?>></a>
...
<div class="footerW clearfix">
    <div class="footer">
        <div class="container clearfix">
            <div class="footer_m clearfix">
                <div class="fot_about">
                    <a href="#" class="fot_logo"><img src="../images/SK_logo_187x42.png" /></a>
                    <div class="text">
                        Solar Kit is located in Chinese sea port city Xiamen. Since founded in 2008, we own an excellent team for design, produce, sales and service. We built our own factory that is more than 3000 square's land. As global supplier in solar mounting brackets, Solar Kit has created added value for customers around the world.&nbsp;
                        ◆Our Product
                        Solar Kit Products includes the following:
                ...
                <div id="right_column" class="fot_tag clearfix">
                    <section id="blockbestsellers" class="block products_block column_box">
                        ...
                        <div class="block_content toggle_content">
                            <ul>
                                <li><a href="#">Metal Roof Solar Mounts</a></li>
                                <li><a href="#">Metal Roof Mount Solar Panels</a></li>
                                <li><a href="#">Solar Panel Tin Roof Mount</a></li>
                                <li><a href="#">Solar Panel Mounts for Metal Roof</a></li>
                                <li><a href="#">Metal Roof Solar Panel Mount</a></li>
                                <li><a href="#">Metal Roof Solar Mounting Structure</a></li>
                                <li><a href="#">Solar Mounting Systems for Metal Roof</a></li>
                                <li><a href="#">Solar Mounting Brackets for Metal Roof</a></li>
                            </ul>
                        </div>
                    </section>
                </div>
                ...
                <div id="right_column" class="fot_con clearfix">
                    <section id="blockbestsellers" class="block products_block column_box">
                        ...
                        <div class="block_content toggle_content">
                            <ul class="list clearfix">
                                <li class="fcon_a">Xiamen Solar Kit Technology Co., Ltd.</li>
                                <li class="fcon_t">Tel : <a rel="nofollow" href="Tel:+86 186 5000 7009">+222222222222</a></li>
                                <li class="fcon_e">Email : <a rel="nofollow" target="_blank" href="mailto:demo@solar-kit.in">demo@solar-kit.in</a></li>
                                <li class="fcon_w">Whatsapp : <a rel="nofollow"  target="_blank" href="https://api.whatsapp.com/send?phone=111111111&amp;text=Hello">111111111</a></li>
                            </ul>
                        </div>
                    </section>
                </div>
    ...
    <div class="footer-bottom clearfix">
        <div class="container">
            <div class="copy">
                Copyright © 2022 Xiamen Solar Kit Technology Co., Ltd. All Rights Reserved.
            </div>
            <div class="foot_ipv6">
                <a href="#">Sitemap</a> | <a href="#">XML</a> | <span>IPv6 network supported</span><img src="template/images/ipv6.png" />
            </div>
        </div>
    </div>
</div>
    ...
    <div id="onlineService" >
        <div class="online_form">
            <div class="i_message_inquiry">
                ...
                <div class="inquiry">
                    <form role="form" action="https://www.Solar Kitpvmount.com/inquiry/addinquiry" method="post" name="email_form" id="email_form1">
...
<div class="fixed-contact-wrap">
    <ul class="item-list clearfix">
        <li class="online_p">
            <div>
                <i class="icon"></i>
                <a rel="nofollow" href="Tel:+123213123123">31231231132</a>
            </div>
        </li>
        <li class="online_e">
            <div>
                <i class="icon"></i>
                <a rel="nofollow" target="_blank" href="mailto:ada@demo.com">demo@solar-kit.in</a>
            </div>
        </li>
        <li class="online_w">
            <div>
                <i class="icon"></i>
                <a rel="nofollow"  target="_blank" href="https://api.whatsapp.com/send?phone=3132131123&amp;text=Hello">31313123</a>
            </div>
        </li>
    </ul>
</div>
