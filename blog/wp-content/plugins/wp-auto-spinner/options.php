								...
								<table  class="form-table">
									...
									<tr>
										...
										<select name="wp_auto_spinner_wordai_uniqueness" >
											<option value="1" <?php opt_selected('1',$wp_auto_spinner_wordai_uniqueness) ?>>More Conservative</option>
											<option value="2" <?php opt_selected('2',$wp_auto_spinner_wordai_uniqueness) ?>>Regular</option>
											<option value="3" <?php opt_selected('3',$wp_auto_spinner_wordai_uniqueness) ?>>More Adventurous</option>
