...
<div class="section">
 ...
 <div class="container">
  ...
  <div class="logos">
    ...
    <a href="" class="button auto">Get Solar-Kit solution</a>

    <a href="" class="button invert auto">Become our partner</a>
...
<div class="section pad50" id="references" style="background-color: #F1F5F9;">
  ...
  $vysledek = mysqli_query($db,"select * from page1 where typ='4' and zakazat='0' order by id desc");
   ...
   ?>  
    ...
    <div class="col s12 m4">
 	    ...
 	    <a href="<?php echo $link."/new/".$row["url"];?>"><img src="http://localhost/solarkitindia.com/<?php echo $row["img"];?>" class="responsive-img"></a>	
  ...
  <p><?php echo substr( strip_tags($row["text"]),0,500);?>...</p>
	...
	<a href="<?php echo $link."/new/".$row["url"];?>">View detail</a>
