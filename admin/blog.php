...
?>
 ...
 <a class="collection-item" href="?add=true" title="Přidat">Blog <div class="right"><i class="material-icons">add</i></div></a>

<?php $vysledek = mysqli_query($db,"select * from page where typ='3' order by id desc");
