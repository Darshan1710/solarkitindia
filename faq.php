                            ...
                            <div class="faq" id="accordion">
                                <div class="card">
                                    ...
                                    <div id="faqCollapse-1" class="collapse" aria-labelledby="faqHeading-1" data-parent="#accordion">
                                        <div class="card-body">
                                            <p>No we are the manufacturers of the module mounting structures.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="card">
                                    ...
                                    <div id="faqCollapse-2" class="collapse" aria-labelledby="faqHeading-2" data-parent="#accordion">
                                        <div class="card-body">
                                            <p>Our Head office is located in Mumbai. We have sales division at Delhi, Gurugoan, Hydrabad, Pune, Bangalore</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="card">
                                    ...
                                    <div id="faqCollapse-3" class="collapse" aria-labelledby="faqHeading-3" data-parent="#accordion">
                                        <div class="card-body">
                                            <p>Our factory is located at Navi- Mumbai.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="card">
                                    ...
                                    <div id="faqCollapse-4" class="collapse" aria-labelledby="faqHeading-4" data-parent="#accordion">
                                        <div class="card-body">
                                            <p>We have rooftop solutions. In which we offer metal roof and flat roof soltution.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="card">
                                    ...
                                    <div id="faqCollapse-5" class="collapse" aria-labelledby="faqHeading-5" data-parent="#accordion">
                                        <div class="card-body">
                                            <p>Services provided by us are-</p>
                                            <ul>
                                                <li>Design</li>
                                                <li>Calculations</li>
                                ...
                                <div class="card">
                                    ...
                                    <div id="faqCollapse-6" class="collapse" aria-labelledby="faqHeading-6" data-parent="#accordion">
                                        <div class="card-body">
                                            <p>Yes, All our structures are tested and certified. We have done load and wind testing for all the solutions.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="card">
                                    ...
                                    <div id="faqCollapse-7" class="collapse" aria-labelledby="faqHeading-7" data-parent="#accordion">
                                        <div class="card-body">
                                            <p>We don't provide installation service but we can provide inspections or supervision during installation. (Only for higher capacity)</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="card">
                                    ...
                                    <div id="faqCollapse-8" class="collapse" aria-labelledby="faqHeading-8" data-parent="#accordion">
                                        <div class="card-body">
                                            <p>We don't have dealership or distribution policy at this moment. We will let you know whenever we will start distribution.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="card">
                                    ...
                                    <div id="faqCollapse-9" class="collapse" aria-labelledby="faqHeading-9" data-parent="#accordion">
                                        <div class="card-body">
                                            <p>We give warranty of 15 years.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="card">
                                    ...
                                    <div id="faqCollapse-10" class="collapse" aria-labelledby="faqHeading-10" data-parent="#accordion">
                                        <div class="card-body">
                                            <p>We have distributed our product all over India. So we can deliver it anywhere in India as per requirement</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="card">
                                    ...
                                    <div id="faqCollapse-11" class="collapse" aria-labelledby="faqHeading-11" data-parent="#accordion">
                                        <div class="card-body">
                                            <p>Delivery time depends totally on location. But approx it will take 4-5 days.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="card">
                                    ...
                                    <div id="faqCollapse-12" class="collapse" aria-labelledby="faqHeading-12" data-parent="#accordion">
                                        <div class="card-body">
                                            <p>We have pull out test certification for all our solutions. Certificates are approved by TUV.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="card">
                                    ...
                                    <div id="faqCollapse-13" class="collapse" aria-labelledby="faqHeading-13" data-parent="#accordion">
                                        <div class="card-body">
                                            <p>We have installated around 20MW capacity last year in India. We installed 2.2GW all around the world.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="card">
                                    ...
                                    <div id="faqCollapse-14" class="collapse" aria-labelledby="faqHeading-14" data-parent="#accordion">
                                        <div class="card-body">
                                            <p>We don't have any minimum and maximum limit for placing orders.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="card">
                                    ...
                                    <div id="faqCollapse-15" class="collapse" aria-labelledby="faqHeading-15" data-parent="#accordion">
                                        <div class="card-body">
                                            <p>We have started manufacturing in India 2 years ago. But we are working in Europe from last 15 years in solar EPC field.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="card">
                                    ...
                                    <div id="faqCollapse-16" class="collapse" aria-labelledby="faqHeading-16" data-parent="#accordion">
                                        <div class="card-body">
                                            <p>Price totally depends on the project capacity and layout of the site. It also depends on the type of solutions you require.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<div class="fixed-contact-wrap">
    <ul class="item-list clearfix">
        ...
        <li class="online_e">
            <div>
                <i class="icon"></i>
                <a rel="nofollow" target="_blank" href="mailto:ada@xyhz.com">ada@xyhz.com</a>
            </div>
        </li>
        <li class="online_w">
            <div>
