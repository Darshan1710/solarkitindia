               ...
               <div class="page-right clearfix">
                  <ul class="news clearfix">
                     <li class="clearfix">
                        <div class="image">
                           <a href="#"></a>
                           <img src="uploadfile/news/33caa5a8c73e64ca8ad247b1712426ec.jpg" alt="How to effectively extend the service life of solar panel mounting brackets?" />
                        </div>
                        <div class="main">
                           <span class="page_date">Mar 29 , 2021</span>    
                           <a class="title" href="#">How to effectively extend the service life of solar panel mounting brackets?</a>
                           <div class="text">Ground photovoltaic system is generally adopts a concrete strip (block) foundation form. The challenges faced by the design of solar panel mounting brackets, the most important feature of the assembly components of any type of solar panel mounting brackets design is weather resistance. The solar mounting structure must be sturdy and reliable, able to withstand atmospheric erosion, wind load and ot...</div>
                           <a rel="nofollow" href="#" class="page_more">view more<i></i></a>
                        </div>
                     </li>
                     <li class="clearfix">
                        <div class="image">
      ...
      <div class="fixed-contact-wrap">
         <ul class="item-list clearfix">
            <li class="online_p">
               <div>
                  <i class="icon"></i>
                  <a rel="nofollow" href="Tel:+131312131">42434242434</a>
               </div>
            </li>
            <li class="online_e">
               <div>
                  <i class="icon"></i>
                  <a rel="nofollow" target="_blank" href="mailto:ada@sdadsad.com">ada@asddadsada.com</a>
               </div>
            </li>
            <li class="online_w">
               <div>
                  <i class="icon"></i>
                  <a rel="nofollow"  target="_blank" href="https://api.whatsapp.com/send?phone=414141414&amp;text=Hello">1414134141</a>
               </div>
            </li>
