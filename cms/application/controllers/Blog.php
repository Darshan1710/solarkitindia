...
class Blog extends CI_Controller
{
    ...
    public function getBlogListDetails()
    {
        ...
        foreach ($memData as $member) {
            $i++;
            $img = !empty($member->img) ? base_url().$member->img : 'https://thumbs.dreamstime.com/b/no-image-available-icon-photo-camera-flat-vector-illustration-132483141.jpg';
            $image = '<img src="'.$img.'" width="50px" height="50px">';
