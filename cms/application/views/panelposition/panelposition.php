            ...
            <div class="page-header page-header-default">
                ...
                <div class="breadcrumb-line">
                    <ul class="breadcrumb">
                        ...
                        <li><a href="#.html">Panel Position</a></li>
                        <li class="active">Panel Position List</li>
                    </ul>
            ...
            <div class="content">
                ...
                <div class="panel panel-flat">
                    <div class="panel-heading">
                        <a class="btn btn-sm btn-success" href="#" data-target="#add_modal" data-toggle="modal"><i class="icon-home4"></i> Add Panel Position</a>
                    </div>


                    <table class="table" id="rail_type_list">
                        <thead>
                        <tr>
                            <th>Sr. No.</th>
                            <th>Name</th>
                                        ...
                                        <ul class="icons-list">
                                            <li class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="#" id="<?php echo $row['id'] ?>" data-toggle="modal" data-target="#edit_modal" class="editRailType"><i class="icon-file-pdf"></i> Edit</a></li>
                                                    <li><a href="#" id="<?php echo $row['id']?>" class="delete" data-table="<?php echo $this->encryption->encrypt('rail_type') ?>"><i class="icon-file-excel"></i> Delete</a></li>
                                                </ul>
                                            </li>
                                        </ul>
                                    </td>
    ...
    $(document).ready(function() {
        ...
        $('#add').submit(function(e) {
            ...
            $.ajax({
                ...
                processData: false,
                contentType: false,
                url: base_url + 'PanelPosition/addPanelPosition',
        ...
        $(document).on('click', '.editRailType', function() {
            var base_url = $('#base_url').val();
            var id = $(this).attr('id');
            $.ajax({
                type: 'post',
                ...
                url: base_url + 'PanelPosition/editPanelPosition',
                success: function(data) {
                    var obj = $.parseJSON(data);
                    if (obj.errCode == -1) {
                        $('.id').val(id);
        ...
        $('#update').submit(function(e) {
            ...
            $.ajax({
                ...
                processData: false,
                contentType: false,
                url: base_url + 'PanelPosition/updatePanelPosition',
                success: function(data) {
                    var obj = $.parseJSON(data);
                    if (obj.errCode == -1) {
                        alert(obj.message);
