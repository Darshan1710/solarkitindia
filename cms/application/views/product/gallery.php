                ...
                <div class="content">
                    ...
                    <div class="panel-body">
                        ...
                        if($this->uri->segment(4) == '3'){
                            ...
                            $url = base_url().'Product/affiliateProductList';
                        }
                        ?>

                        <a href="<?php echo $url ?>" class="btn btn-s-sm btn-danger btn-rounded pull-right">Go Back</a>
                    </div>
                        ...
                        <div class="panel-body">
                            <legend></legend>
                                ...
                                <!-- <div class="col-md-3 text-center">
                                    ...
                                    <a href="#" >
                                       <?php display_gallery_image($row['thumbnail']); ?>

                                    </a>
                                    
                                </div> -->
                                <div class="col-md-3 context-menu-one text-center text-bold" photo-id="<?php echo $row['id']; ?>" id="image_div">
                                      ...
                                      <div class="context-data-menu_<?php echo $counter; ?>">
                                                <ul class="dropdown-menu">
                                                    <li><a href="#" class="edit" id="<?php echo $row['id'] ?>" data-type="<?php echo $this->uri->segment(4) ?>"><i class="icon-copy4"></i> Edit</a></li>
                                                    <li><a href="#" class="deleteimage" id="<?php echo $row['id'] ?>" data-type="<?php echo $this->uri->segment(4) ?>"><i class="icon-paste3"></i> Delete</a></li>
