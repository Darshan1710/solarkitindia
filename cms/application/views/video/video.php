            ...
            <div class="content">
                ...
                <div class="panel panel-flat">
                    <div class="panel-heading">
                        <a class="btn btn-sm btn-success" href="#" data-target="#add_modal" data-toggle="modal"><i class="icon-home4"></i> Add Video</a>
                    </div>
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <label>Link</label>
                                <input type="text" placeholder="BX912HLMLi0" class="form-control link" name="link" >
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
    ...
    $(document).ready(function() {
        ...
        $('#update').submit(function(e) {
            ...
            $.ajax({
                ...
                processData: false,
                contentType: false,
                url: base_url + 'Video/updateVideo',
                success: function(data) {
                    var obj = $.parseJSON(data);
                    if (obj.errCode == -1) {
                        alert(obj.message);
