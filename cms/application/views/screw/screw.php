            ...
            <div class="content">
                ...
                <div class="panel panel-flat">
                    <div class="panel-heading">
                        <a class="btn btn-sm btn-success" href="#" data-target="#add_modal" data-toggle="modal"><i class="icon-home4"></i> Add Screw</a>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <select class="form-control select" id="rail_type_id" name="rail_type_id">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control select" id="panel_position_id" name="panel_position_id">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <label>Rail Type</label>
                                <select class="form-control rail_type_id select" id="rail_type_id" name="rail_type_id">
                                    <option>Select Rail Type</option>
                                    <?php if(isset($railType)):
                                        foreach($railType as $row){ ?>
                                            <option value="<?= $row['id'] ?>" ><?= $row['name'] ?></option>
                            ...
                            <div class="col-md-6">
                                <label>Panel Position</label>
                                <select class="form-control panel_position_id select" id="panel_position_id" name="panel_position_id">
                                    <option>Select Panel Position</option>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-6">
                                <label>Roof Type</label>
                                <select class="form-control roof_type_id select" id="roof_type_id" name="roof_type_id">
                                    <option>Select Roof Type</option>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $(document).on('click', '.editScrew', function() {
            var base_url = $('#base_url').val();
            var id = $(this).attr('id');
            $.ajax({
                type: 'post',
                ...
                success: function(data) {
                    ...
                    if (obj.errCode == -1) {
                        ...
                        $(".height_id").val(obj.data.height_id);
        ...
        $('#update').submit(function(e) {
            ...
            $.ajax({
                ...
                processData: false,
                contentType: false,
                url: base_url + 'Screw/updateScrew',
                success: function(data) {
                    var obj = $.parseJSON(data);
                    if (obj.errCode == -1) {
                        alert(obj.message);
        ...
        $('#panel_position_id').on('change',function(e) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (obj.errCode == -1) {
                        $('#roof_type_id').empty();
                        $('#roof_type_id').append('<option value="">Please Select Roof Type</option>');
                        $.each(obj.message, function(key, value) {
        ...
        $('#roof_type_id').on('change',function(e) {
            e.preventDefault();
            var rail_type_id = $('#rail_type_id').val();
            var panel_position_id = $('#panel_position_id').val();
            var roof_type_id = $('#roof_type_id').val();
            var base_url = $('#base_url').val();
            $.ajax({
                type: 'post',
                data: {'rail_type_id':rail_type_id,'panel_position_id':panel_position_id,'roof_type_id':roof_type_id},
                url: base_url + 'Height/getHeight',
                success: function(data) {
                    var obj = $.parseJSON(data);
                    if (obj.errCode == -1) {
                        $('#height_id').empty();
                        $('#height_id').append('<option value="">Please Select Height</option>');
                        $.each(obj.message, function(key, value) {
                            $('#height_id').append('<option value="'+value.id+'">'+value.name+'</option>');
                        });
                    } else if (obj.errCode == 2) {
                        alert(obj.message);
                    } else if (obj.errCode == 3) {
