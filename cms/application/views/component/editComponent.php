        ...
        <div class="content-wrapper">
            ...
            <div class="page-header page-header-default">
                ...
                <div class="breadcrumb-line">
                    <ul class="breadcrumb">
                        <li><a href="<?php echo base_url() ?>Admin/dashboard"><i class="icon-home2 position-left"></i>
                                Home</a></li>
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        ...
                                        <input type="text" placeholder="Title" class="form-control" name="title"
                                               id="title"
                                               value="<?= isset($component) && !empty($component) ? $component['title'] : '' ?>">
                                    </div>
                                    <div class="col-sm-3">
                                        <label>Project Image (200 x 200)</label><br>
                                        <img class="image" width="50px" height="50px"
                                             src="<?= isset($component) && !empty($component) ? base_url() . $component['thumbnail'] : '' ?>">
                                        <button class="btn btn-sm btn-primary change_image" type="button">Change Image
                                        </button>
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <input type="text" placeholder="Tags" class="form-control" name="tags" id="tags"
                                               value="<?= isset($component) && !empty($component) ? $component['tags'] : '' ?>">
                                    </div>
                                    <div class="col-sm-3">
                                        ...
                                        <select class="form-control select" name="category" id="category">
                                            ...
                                            <option value="1" <?= isset($component) && !empty($component) && $component['category_id'] == $categoryRow['id'] ? 'selected' : '' ?>>
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        ...
                                        <select class="form-control select" name="product_status" id="product_status">
                                            ...
                                            <option value="1" <?= isset($component) && !empty($component) && $component['product_status'] == '1' ? 'selected' : '' ?>>
                                                Regular Products
                                            </option>
                                            <option value="2" <?= isset($component) && !empty($component) && $component['product_status'] == '0' ? 'selected' : '' ?>>
                                                Hor Products
                                            </option>
                                        </select>
                                    </div>
                                    <div class="col-sm-3">
                                        ...
                                        <select class="form-control select" name="status" id="status">
                                            <option value="">Please Select Status</option>
                                            <option value="1" <?= isset($component) && !empty($component) && $component['status'] == '1' ? 'selected' : '' ?>>
                                                Active
                                            </option>
                                            <option value="0" <?= isset($component) && !empty($component) && $component['status'] == '0' ? 'selected' : '' ?>>
                                                Inactive
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <textarea name="short_description" class="form-control" id="short_description">
                                            <?= isset($component) && !empty($component) ? $component['short_description'] : '' ?>
                                        </textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <textarea name="long_description" class="form-control" rows="10"
                                                  id="long_description">
                                            <?= isset($component) && !empty($component) ? $component['long_description'] : '' ?>
                                        </textarea>
                                    </div>
                                </div>
                            </div>
    ...
    $(document).ready(function () {
        ...
        $('#add').submit(function (e) {
            ...
            $.ajax({
                ...
                processData: false,
                contentType: false,
                url: base_url + 'Component/updateComponent',
                success: function (data) {
                    var obj = $.parseJSON(data);
                    if (obj.errCode == -1 || obj.errCode == 2) {
                        alert(obj.message);
                        window.location.href = base_url + 'Component/compoentList'
