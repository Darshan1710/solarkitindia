            ...
            <div class="page-header page-header-default">
                ...
                <div class="breadcrumb-line">
                    <ul class="breadcrumb">
                        ...
                        <li><a href="#.html">Rail Type</a></li>
                        <li class="active">Rail Type List</li>
                    </ul>
            ...
            <div class="content">
                ...
                <div class="panel panel-flat">
                    <div class="panel-heading">
                        <a class="btn btn-sm btn-success" href="#" data-target="#add_modal" data-toggle="modal"><i class="icon-home4"></i> Add Rail Type</a>
                    </div>
    ...
    $(document).ready(function() {
        ...
        $('#add').submit(function(e) {
            ...
            $.ajax({
                ...
                processData: false,
                contentType: false,
                url: base_url + 'RailType/addRailType',
        ...
        $(document).on('click', '.editRailType', function() {
            ...
            $.ajax({
                ...
                url: base_url + 'RailType/editRailType',
                success: function(data) {
                    var obj = $.parseJSON(data);
                    if (obj.errCode == -1) {
                        $('.id').val(id);
        ...
        $('#update').submit(function(e) {
            ...
            $.ajax({
                ...
                processData: false,
                contentType: false,
                url: base_url + 'RailType/updateRailType',
                success: function(data) {
                    var obj = $.parseJSON(data);
                    if (obj.errCode == -1) {
                        alert(obj.message);
