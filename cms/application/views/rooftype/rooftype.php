            ...
            <div class="page-header page-header-default">
                ...
                <div class="breadcrumb-line">
                    <ul class="breadcrumb">
                        ...
                        <li><a href="#.html">Roof Type</a></li>
                        <li class="active">Roof Type List</li>
                    </ul>
            ...
            <div class="content">
                ...
                <div class="panel panel-flat">
                    <div class="panel-heading">
                        <a class="btn btn-sm btn-success" href="#" data-target="#add_modal" data-toggle="modal"><i class="icon-home4"></i> Add Roof Type</a>
                    </div>
                                        ...
                                        <ul class="icons-list">
                                            <li class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="#" id="<?php echo $row['id'] ?>" data-toggle="modal" data-target="#edit_modal" class="editRoofType"><i class="icon-file-pdf"></i> Edit</a></li>
                                                    <li><a href="#" id="<?php echo $row['id']?>" class="delete" data-table="<?php echo $this->encryption->encrypt('roof_type') ?>"><i class="icon-file-excel"></i> Delete</a></li>
                                                </ul>
                                            </li>
                                        </ul>
                                    </td>
    ...
    <div class="modal-dialog ">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h5 class="modal-title">Roof Type</h5>
            </div>
    ...
    $(document).ready(function() {
        ...
        $('#add').submit(function(e) {
            ...
            $.ajax({
                ...
                processData: false,
                contentType: false,
                url: base_url + 'RoofType/addRoofType',
        ...
        $(document).on('click', '.editRoofType', function() {
            ...
            $.ajax({
                ...
                url: base_url + 'RoofType/editRoofType',
                success: function(data) {
                    var obj = $.parseJSON(data);
                    if (obj.errCode == -1) {
                        $('.id').val(id);
        ...
        $('#update').submit(function(e) {
            ...
            $.ajax({
                ...
                processData: false,
                contentType: false,
                url: base_url + 'RoofType/updateRoofType',
                success: function(data) {
                    var obj = $.parseJSON(data);
                    if (obj.errCode == -1) {
                        alert(obj.message);
