                ...
                <div class="page-header page-header-default">
                    ...
                    <div class="breadcrumb-line">
                        <ul class="breadcrumb">
                            ...
                            <li><a href="#.html">Sub Category</a></li>
                ...
                <div class="content">
                    ...
                    <div class="panel panel-flat">
                        <div class="panel-heading">
                            <a class="btn btn-sm btn-success" href="#" data-target="#add_modal" data-toggle="modal"><i class="icon-home4"></i> Add Sub Category</a>
                        </div>
                                        ...
                                        <ul class="icons-list">
                                            <li class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="#" id="<?php echo $row['subcategory_id'] ?>" data-toggle="modal" data-target="#edit_modal" class="editSubCategory"><i class="icon-file-pdf"></i> Edit</a></li>
                                                    <li><a href="#" id="<?php echo $row['id']?>" class="deleteSubCategory"><i class="icon-file-excel"></i> Delete</a></li>
                                                </ul>
                                            </li>
                                        </ul>
                                    </td>
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" placeholder="Sub Category Name" class="form-control" name="sub_category" id="sub_category">
                                </div>
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <label>Sub Category</label>
                                    <input type="text" placeholder="Sub Category Name" class="form-control sub_category" name="sub_category">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.editSubCategory', function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (obj.errCode == -1) {
                        $('.id').val(id);
                        $(".category").select2().select2('val', obj.data.category_id);
                        $(".status").select2().select2('val', obj.data.status);
                        $(".sub_category").val(obj.data.sub_category);
        ...
        $('#update').submit(function(e) {
            ...
            $.ajax({
                ...
                processData: false,
                contentType: false,
                url: base_url + 'SubCategory/updateSubCategory',
                success: function(data) {
                    var obj = $.parseJSON(data);
                    if (obj.errCode == -1) {
                        alert(obj.message);
